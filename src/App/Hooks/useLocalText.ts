...
export const TranslatedFailText = 'Can not get words translation. Please try again!'
...
const eng = {
  ...
  out_of_trial: "You installed Vocaby @@ days ago. You are out of the ##-day trial period.\n\nPlease upgrade to Pro to unlock all levels!",
  introduce_trial: "You installed Vocaby @@ days ago.\n\nYou can change to any level during the ##-day trial. After this period, you can only continue using the selected level.\n\nUpgrade to Pro to unlock all levels and select whichever level you want from then on.",
...
They are set up until 24/Oct/1994 at 00:00. Please open the app and set new ones after this time.`,
  ...
  fail_translate: TranslatedFailText,
