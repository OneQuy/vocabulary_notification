...
const eng = {
  ...
  out_of_trial: "You are out of the trial period. Please upgrade to Pro to unlock all levels!",
  introduce_trial: "You can change to any level during the ##-day trial. After this period, you can continue using the selected level. Upgrade to Pro to unlock all levels from now on.",
